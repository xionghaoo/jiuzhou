...
function checkusername() {
    ...
    if (account == '' || account == null) {
        layer.alert("用户名不能为空！", {icon: 2, shade: 0});
        return false;
    }
    if (!tel.test(account)) {
        layer.alert("请输入正确格式的用户名！", {icon: 2, shade: 0});
        return false;
    }
    return true;
}
...
function checkAccount() {
    $.ajax({
        ...
        success: function (response) {
            if (response) {
                layer.alert("用户名已被注册！", {icon: 2, shade: 0});
                return false;
            }
            return true;
        }
...
function checkpassword() {
    ...
    if (password == '' || password == null) {
        layer.alert("密码不能为空！", {icon: 2, shade: 0});
        return false;
    }
    if (!tel.test(password)) {
        layer.alert("密码输入错误！", {icon: 2, shade: 0});
        return false;
    }
    return true;
}
...
function checkfullname() {
    ...
    if (fullName == '' || fullName == null) {
        layer.alert("真实姓名不能为空！", {icon: 2, shade: 0});
        return false;
    }
    if (!Ch.test(fullName)) {
        layer.alert("真实姓名输入错误！", {icon: 2, shade: 0});
        return false;
    }
    return true;
}
...
function checkUnique() {
    ...
    $.ajax({
        ...
        success: function (msg) {
            if (msg) {
                layer.alert("真实姓名已被使用，请联系客服！", {icon: 2, shade: 0});
                b = false;
            }
        }
    });
...
function checkPhoneUnique() {
    ...
    $.ajax({
        ...
        success: function (msg) {
            if (msg) {
                layer.alert("手机号码已被使用，请联系客服！", {icon: 2, shade: 0});
                b = false;
            }
        }
    });
...
function checkpwd() {
    ...
    if (pwd1 == '' || pwd1 == null || pwd2 == '' || pwd2 == null || pwd3 == '' || pwd3 == null || pwd4 == '' || pwd4 == null) {
        layer.alert("取款密码不能为空！", {icon: 2, shade: 0});
        return false;
    }
    return true;
}
...
function checkemail() {
    ...
    if (email == '' || email == null) {
        layer.alert("email不能为空！", {icon: 2, shade: 0});
        return false;
    }
    if (!tel.test(email)) {
        layer.alert("email输入错误！", {icon: 2, shade: 0});
        return false;
    }
    return true;
}
...
function checkphone() {
    ...
    var tel = /^1\d{10}$/;
    if (phone == '' || phone == null) {
        layer.alert("电话号码不能为空！", {icon: 2, shade: 0});
        return false;
    }
    if (!tel.test(phone)) {
        layer.alert("请输入中国境内手机号！", {icon: 2, shade: 0});
        return false;
    }
    return true;
}
...
function checkqq() {
    ...
    var tel = /^[1-9]\d{4,9}$/;
    if (qq == '' || qq == null) {
        layer.alert("QQ不能为空！", {icon: 2, shade: 0});
        return false;
    }
    if (!tel.test(qq)) {
        layer.alert("QQ输入错误！", {icon: 2, shade: 0});
        return false;
    }
    return true;
}
...
function checkweixin() {
    ...
    if (weixin == '' || weixin == null) {
        layer.alert("微信不能为空！", {icon: 2, shade: 0});
        return false;
    }
    if (!tel.test(weixin)) {
        layer.alert("微信输入错误！", {icon: 2, shade: 0});
        return false;
    }
    return true;
}
...
function submitRegistr() {
    ...
    if (_intrCode == 1) {
        ...
        if (intrCode == '' || intrCode == null) {
            layer.alert("推广码不能为空！！", {icon: 2, shade: 0})
            return;
        }
    }
    if (!checkusername()) {
    ...
    if ($("#confirmPassword").val() != $("#passwd").val()) {
        layer.alert("两次输入的密码不同，请重新输入！", {icon: 2, shade: 0});
        return;
    }
    if (_vCode > 0) {
        var vcode_val = $("#vCodeReg").val();
        if (vcode_val == '' || vcode_val == null) {
            layer.alert("请输入验证码", {icon: 2, shade: 0});
            return;
        }
    }
    if (_fullName == 1) {
    ...
    if (_birthday == 1) {
        ...
        if (year == '' || year == null || month == '' || month == null || day == '' || day == null) {
            layer.alert("请输入您的生日", {icon: 2, shade: 0});
            return;
        }
    }
    if (_fundPwd == 1) {
    ...
    layer.confirm('是否确定以该信息注册？', {btn: ['确认', '我再改改'], shade: 0}, function (index) {
        layer.close(index);
        var params = {};
